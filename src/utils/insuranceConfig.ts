...
export const LTD_CONFIG = {
  Basic: { maxBenefit: 15000, costPerHundred: 0.305 },
  Premium: { maxBenefit: 8333.33, costPerHundred: 0.209 }
};
...
export const ACCIDENT_PREMIUMS: Record<Plan, Record<EligibilityOption, number>> = {
  Basic: { Individual: 11.74, 'Individual + Spouse': 23.05, 'Individual + Children': 27.68, Family: 32.67 },
  Premium: { Individual: 7.94, 'Individual + Spouse': 15.07, 'Individual + Children': 18.89, Family: 22.27 }
};
...
export const ZIP_CODE_REGIONS: Record<number, string[]> = {
  1: ['350', '351', '354', '355', '360', '361', '363', '364', '366', '367', '368', '369', '716', '717', '718', '719', '720', '721', '723', '728', '335', '310', '312', '313', '314', '317', '318', '319', '150', '151', '153', '154', '155', '156', '157', '158', '159', '160', '161', '166', '248', '255', '257', '260', '265', '454', '456', '376', '380', '381', '382', '383', '384', '780', '783', '784', '785', '794', '798'],
    ...
    5: ['860', '900', '901', '902', '905', '914', '915', '916', '931', '945', '946', '947', '948', '950', '060', '061', '062', '063', '064', '331', '332', '300', '304', '305', '967', '968', '460', '461', '462', '466', '472', '476', '478', '479', '703', '706', '707', '708', '710', '711', '040', '042', '207', '208', '209', '217', '010', '011', '012', '027', '480', '481', '483', '485', '486', '487', '395', '631', '650', '651', '893', '894', '071', '072', '073', '086', '087', '117', '119', '130', '131', '137', '138', '139', '145', '271', '272', '273', '274', '275', '281', '284', '285', '286', '288', '289', '444', '445', '447', '453', '455', '457', '735', '736', '739', '740', '743', '192', '193', '028', '295', '841', '846', '201', '220', '221', '222', '223', '226', '227', '228', '244'],
    6: ['996', '906', '907', '908', '910', '911', '912', '913', '917', '918', '926', '927', '949', '953', '954', '955', '959', '960', '961', '802', '809', '815', '065', '066', '068', '069', '967', '968', '836', '837', '600', '601', '603', '605', '606', '608', '463', '464', '465', '467', '468', '469', '475', '477', '502', '503', '507', '509', '510', '511', '512', '513', '520', '522', '523', '524', '525', '526', '527', '528', '662', '668', '669', '672', '675', '678', '679', '039', '210', '211', '216', '016', '017', '020', '021', '022', '488', '489', '491', '492', '498', '499', '550', '551', '553', '554', '555', '558', '559', '560', '561', '562', '563', '564', '565', '566', '567', '395', '631', '650', '651', '598', '599', '681', '683', '684', '685', '686', '687', '688', '689', '690', '691', '692', '693', '895', '897', '898', '077', '078', '088', '089', '104', '109', '454', '456', '744', '748', '152', '162', '163', '164', '165', '167', '170', '171', '029', '570', '571', '572', '573', '574', '575', '576', '577', '780', '783', '784', '785', '794', '798', '845', '230', '231']
    // ... (other regions)
};
